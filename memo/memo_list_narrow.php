...
<div class="memo narrow">
    ...
    <div class="memo_info">
        ...
        <div class="memo_favorite">
            <button class="btn modal_btn" data-target="#modal<?= $memo['id'] ?>_narrow" type="button" data-toggle="memo"
                title="投稿"><i class="fas fa-comment-dots"></i></button>
            <span class="memo_comment_count"><?= current(get_memo_comment_count($memo['id'])) ?></span>
        </div>
        <div class="comment_confirmation" id="modal<?= $memo['id'] ?>_narrow">
        ...
        <button class="btn modal_btn" data-target="#edit_modal<?= $memo['id'] ?>_narrow" type="button"
            data-toggle="edit" title="編集"><i class="fas fa-edit"></i></button>
        <div class="memo_edit" id="edit_modal<?= $memo['id'] ?>_narrow">
            <p>投稿内容更新</p>
        ...
        <button class="btn modal_btn" data-target="#delete_modal<?= $memo['id'] ?>_narrow" type="button"
            data-toggle="delete" title="削除"><i class="far fa-trash-alt"></i></button>
        <div class="delete_confirmation" id="delete_modal<?= $memo['id'] ?>_narrow">
